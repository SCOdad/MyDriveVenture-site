(() => {
  ...
  function render(){
    ...
    window.DV_GAME_DV03?.showFallback('Riley Roadster');window.dispatchEvent(new CustomEvent('dv:dashboard-rendered',{detail}));
    set('driver-heading','Riley Roadster');set('hours-sign','31.5 HOURS TO LEVEL 2');set('kpi-hours','18.5 h');set('kpi-drives','34');set('license-stage','LEVEL 1');set('license-date','MAY 18, 2026');set('age-gate','NOV 18, 2026');set('dash-xp','4,850');set('kpi-night','3.4 h');set('license-night-hours','3.4 / 10.0 h');set('dash-clock','5:42 PM');
