(() => {
  ...
  const LAYERS=Object.freeze([
    ...
    {key:'03',id:'background',label:'Background',options:[
      ...
      {value:'shopping-center',label:'Shopping Center',sortKey:'03-BACKGROUND-SHOPPING-CENTER',src:'/assets/images/dv03/layers/DV03-L10-SHOPPING-CENTER-BACKGROUND.png'},
      {value:'coffee-shop',label:'Coffee Shop',sortKey:'03-BACKGROUND-COFFEE-SHOP',src:'/assets/images/dv03/layers/DV03-L11-COFFEE-SHOP-BACKGROUND.png'},
      {value:'salon-barber',label:'Salon / Barber',sortKey:'03-BACKGROUND-SALON-BARBER',src:'/assets/images/dv03/layers/DV03-L12-SALON-BARBER.png'},
      {value:'movie-theater',label:'Movie Theater',sortKey:'03-BACKGROUND-MOVIE-THEATER',src:'/assets/images/dv03/layers/DV03-L13-MOVIE-THEATER-BACKGROUND.png'}]},
