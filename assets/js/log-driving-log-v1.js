(() => {
  ...
  function normalizeExperienceUi() {
    ...
    if (route === 'dv03' && bar) bar.innerHTML = '<span><b>Current Experience</b> · DV03</span><a href="/log/DV00/">Classic Experience</a>';
    if (route === 'dv02' && bar) bar.innerHTML = '<span><b>Old Experience</b> · DV02</span><a href="/log/">Current Experience</a>';
    if (route === 'dv00' && classicSwitch) classicSwitch.innerHTML = '<strong>Classic Experience</strong> · No-frills base experience <a href="/log/">Current Experience →</a>';
  }
