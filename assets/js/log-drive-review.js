(() => {
  ...
  function syncDriverUrl(driverId){if(!validDriver(driverId))return;const u=new URL(location.href);u.searchParams.set('driver',driverId);history.replaceState(history.state,'',u.pathname+u.search+u.hash)}
