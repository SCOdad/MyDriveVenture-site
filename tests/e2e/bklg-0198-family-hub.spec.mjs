  ...
  await page.setContent(`<!doctype html><html><body>
    <main>
      ...
      <div id="family-app" hidden>
        ...
        <button id="family-see-all-drivers" type="button" hidden aria-expanded="false">See all drivers</button>
        <div id="family-grownups"></div>
        <div id="family-pending-invites"></div>
        <section id="grownup-panel" hidden>
          <form id="grownup-email-form"><input name="email"></form>
          <form id="add-grownup-form" hidden><input id="grownup-confirmed-email" name="email"><div id="new-grownup-fields"><input name="name"></div><div id="grownup-account-result"></div><div id="grownup-driver-scope"></div><div id="grownup-lookup-status"></div><div id="grownup-status"></div></form>
        </section>
        <section id="driver-panel" hidden>
          <form id="add-driver-form">
            <input name="name" value="First Driver"><input name="birth_date" value="2010-01-01"><input name="home_zip" value="48301"><input name="email" value="driver@fixture.invalid"><input name="mobile" value=""><input name="license_stage" value="LEVEL_1"><input name="license_stage_start_date" value="2026-09-01"><input name="favorite_color" value="GREEN"><input name="vehicle_name" value="Test Car"><input name="vehicle_class" value="Sedan"><input name="vehicle_color" value="Gray">
            <div id="driver-status"></div><button type="submit">Add driver</button>
          </form>
        </section>
      </div>
    </main>
