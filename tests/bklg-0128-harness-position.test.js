...
test('BKLG-0128 harness reserves space below the DV03 windshield',()=>{
  ...
  assert.match(html,/bklg-0128-harness-below-scene\.js\?v=20260911-native-drive-thru1/);
  assert.match(html,/bklg-0128-dv03-staging\.js\?v=20260911-native-drive-thru1/);
