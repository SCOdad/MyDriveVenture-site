...
test('DV03 mock mode is DEV-only and disables write controls',()=>{
  ...
  assert.match(html,/log-game-dv03\.js\?v=20260916-0187-assets1/);
  assert.match(read('assets/js/log-game-dv03.js'),/dv03-presentation-rules\.js\?v=20260916-0187-assets1/);
